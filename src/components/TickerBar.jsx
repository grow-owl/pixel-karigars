      ...
      <div className="animate-ticker flex items-center whitespace-nowrap gap-4">
        {[...items, ...items, ...items, ...items].map((item, idx) => {
          ...
          return (
            <div 
              key={idx} 
              className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/10 border border-white/15 backdrop-blur-md hover:bg-white/15 hover:border-[#FF6B4A]/50 transition-all shadow-md shrink-0"
            >
